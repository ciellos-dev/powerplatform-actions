...
function Invoke-ApplySolutionUpgrade {
    [CmdletBinding()]
    param (
    ...
    process {
        $output = Apply-SolutionUpgrade @Parameters -InformationAction Continue
    }
    end {
        return $output
    }
...
try {
    ...
    Write-Verbose "ApplySolutionUpgrade to org: $($authInfo.EnvironmentUrl)..."
    Invoke-ApplySolutionUpgrade $authInfo `
        -SolutionName $solutionName `
        -AsyncOperation $asyncOperation `
        -MaxAsyncWaitTime $asyncWaitTimeout
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvpSMqVz4pqOkf
# lKL4g51WA3K14GXoOGguJqLa49vulqCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgmBt25FDT
# bQLFA1QULXittBLrBRS6R4YjEKyuXi1MbRAwNAYKKwYBBAGCNwIBDDEmMCSgEoAQ
# AFQAZQBzAHQAUwBpAGcAbqEOgAxodHRwOi8vdGVzdCAwDQYJKoZIhvcNAQEBBQAE
# ggEAn7y/kP57z7029kprj5HXWLBrrJJ4OAojF9p3HxJHEyDmRcHZHIsdL8z0iS7o
# ueuveMkhWTIqh3228IH3eLJysWBf05xqpXyZCIE5JsB6ngvHPRtRGNEx7vR/PY5c
# bp+WZDALCwNaddJ9lS4ae0uKMjQxitvsGgqJVHPI9gZ9CggsRTpopNqvrnNrrnSv
# 3TY1MdglizCzxnFKLsd5BqGAiOFR0zw7BmdvT7JFKGp25Fp5mi227lAfLDOTgQQ2
# xidu1sLUimkuoVlaPAkWOGAITWPtavNuqwQSFiEVYmirJGNgeuiwYAGjgYICk0Db
# O3ZCXOaatQf+j6j7qL/cq0zp3KGCFwkwghcFBgorBgEEAYI3AwMBMYIW9TCCFvEG
...
# AQUABCDZiV5CvK+bhOQNx5nVbZ2uJRXJFDuj8VTaJdMud+TVLgIGYrHEVDvGGBMy
# MDIyMDcwNzIxNDIyNi40NzhaMASAAgH0oIHUpIHRMIHOMQswCQYDVQQGEwJVUzET
...
# LwYJKoZIhvcNAQkEMSIEIGexKfN+9bku7KXXRLUMI99zckUfMKhFSxDluOPMZeJ6
...
# 7svF7dzboygBfIMXnjANBgkqhkiG9w0BAQsFAASCAgBTfGfBv4iSlX5DMxEztP49
# 6/Jiyz1TaUK2PPO9MB0G5MmSSZDsKD6nt4sFM/yDM605HcCSqchND0jBDwj6Jj/Q
# wUGC5yR3FiXVKy/XQlppmckIYh9kl7nE5LRe1FE26iUePwEjCJx4AfRMLVaZ+oBL
# 4IwOb1LvNCeZgD1Kjs6wXR6W9K2a+u3uJY/SzkrJbm8WlrOFCI/CLfhLd0Vq3G4h
# bkaMYkdL0LJpheMCqGIadBULrQxkIVTHLNsL9s/4yu+kfAA03SzbV99zmHc4CR37
# AFp4AK4sow1W6OdKzXnupBgYF+q1XeEG8p0FtKCWdV1Z8ppP4K8yzUrnQBSjDmhU
# QPJ6ZfcL15SokV0AEngA4bZGSadsN3HYDCO6s5vMZ0jPa9b08zrHw/7PCmVHTnEc
# 6j+yTcfv0vlh6PSaWET55BputeAGhufKy0qme8i66/+hPsd06Km1QcF5SiMGEiqC
# 1L4O11NRwVt6S5tuF1uDGuARm4n6WNJ2GDcoRRIlAXvkp8euvSejJ+i725RCKa0n
# f5yGIuqH5hdWZp8fIHFBXiHs/NQxdTQ5My0GzrALyvKWDxQeov8vHnzxCt9KIvL0
# azQQqq+QljKse/WTNoQRZqEITi8sA97chUfPl6KDAGazt6uLQ2yFt17ox/4ZbRs/
# S9inTsPG/AGLtdD17B+Rog==

...
function Invoke-PublishCustomizations {
    ...
    process {
        ...
        Publish-AllCustomizations @Parameters -InformationAction Continue
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCh7bXWDwcU1waU
# dglWrgZzA9vBa1e2Zqxxf+IK+Dm7JqCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgGZumUj7k
# kvIPlDuKRNJV90IFVvAXxdJGCwWD4pm51WUwNAYKKwYBBAGCNwIBDDEmMCSgEoAQ
# AFQAZQBzAHQAUwBpAGcAbqEOgAxodHRwOi8vdGVzdCAwDQYJKoZIhvcNAQEBBQAE
# ggEAwQI4/lR2/iZ30f4AuPvI5aAD/7MKCPxQuM9qh6Yb5o7c5sIbxBoSlS5sn5CG
# sl6p7gj0RQ4u3ywtZydEB/UXfht2Kk4f67bao55jeswtiFFfIOahaJjNUXqrocpP
# 8mzoeLfnF3kVoLZxHJCmJWuAzCSxEIr4NGPeo06r77HFEegfcZ9pVyb6W5CN7G7v
# OPqFEvhPwHQfV67ZW5PG61fNHL1HAmf80ojaMjMNhPlM8scrZ7nuxEsclkLlQnZF
# VA+VaC210RmuteCoA/r3KrUNUpa7e8fiGX9YZLE1fgdVRxUIP23NfSzhtg149Fi6
# EcQlGy2xJxFaAgJmINij/zeSPaGCFwwwghcIBgorBgEEAYI3AwMBMYIW+DCCFvQG
...
# AQUABCDNX/gF7okWkLgv20mPPyhiVkpKFPOvkdIPKN/6mNqTOgIGYrH6FztuGBMy
# MDIyMDcwNzIxNDIyNC4zNDJaMASAAgH0oIHUpIHRMIHOMQswCQYDVQQGEwJVUzET
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJoPIuZHF/Cvx3ci/QjPPumBt0lH0Ls5G5UbYRBp
# aVTAMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgzQYLQ3fLn/Sk4xn9Ruuy
...
# +F3YzLuxr4b3h5i8I6kxwDANBgkqhkiG9w0BAQsFAASCAgBH8bSdNL3xxirIL/SB
# cdOWelFOVIP52ulncGkBinU50fD6jYoSjoNVbmGRxYm2VsDJGh2VvHh4Iaf2W7v3
# g0znm1GUFdl+tX02CGqOraMUbmt2+u5Nf+AxT98aVR0ejJSq2KrFJgXIN/GkpwA5
# 0+jHOGPvRw+EFOx2+oIRC4S6X3PUpqCJig2FYJpd40et3uTXlMPRUj4ZNgSXBUXE
# o+ws55lr21UJcl9Nuxz8niJ7IKHCHM7ofcw47VZRp9EFyvbg1U2Z9E7ANvmAUF/Z
# IQsG0L11oB8arKVKcMTM/d5Nwq351VxZWnlLwkoAQXT9r3g70IqlwAyMWJZY8A27
# Ra+Ai49alPukIraEg9m2D+JXZpT/an+zJ6nTi0ZASEZeegMyvzAyiJMiGdMmLRnE
# UxjMm0d+A7U7siZRL2kXe2SPxZSJAjMMKhO0KIFEFb1s6eWE9Wzv3xSwEuLBJrvq
# h7widWCVM6AIIWASFcTaL/1uHPBfsFwMvphyi0kw+9KPl7zCnItxrsW86dToXPOl
# ughAzSKKmLtj4/WgSMgiDwXYG9ybzzdfPtoibK/Uy+FiMBp59CyDWNIDv/NPujMZ
# zEnI0b+0UUc7v/uA4Loh3Ox1cugZqDFgjqmkx+COUbnD1/paUudXP7p1n5hhwd+t
# /c9vQ8Yowr5wcu+6XRqJp9nJjw==
